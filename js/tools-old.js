...
Object.prototype.siblings = function(str){
	var arr = [],that = this[0] || this,ele = that;
...
Object.prototype.parents = function(str){
	var that = this,arr = [],parents = that.parentNode;
	if(that.length){
		return that;
	}
	if(str){
...
Object.prototype.css = function(name,value){
	var that = this,
		...
		toName = function(_name){
			var index = _name.indexOf("-"),_name = _name;
			if(index !== -1){
